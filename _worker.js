...
const proxyIPs= ['cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org', 
		 'edgetunnel.anycast.eu.org', 'www.blshe.net', 
		 'cfip.cfcdn.vip', 'speed.marisalnc.com', 
		 'cdn.2020111.xyz'
		];
...
const buildDNSObject = async (remoteDNS, localDNS, blockAds, bypassIran, blockPorn, isWorkerLess) => {
    ...
    if (isWorkerLess) {
        ...
        const resolvedCLDomain = await resolveDNS('cfip.cfcdn.vip.cdn.cloudflare.net');
